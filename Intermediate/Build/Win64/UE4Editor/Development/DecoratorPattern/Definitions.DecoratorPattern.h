...
#define UE_PROJECT_NAME DecoratorPattern
#define UE_TARGET_NAME DecoratorPatternEditor
#define UE_MODULE_NAME "DecoratorPattern"
...
#define DECORATORPATTERN_API DLLEXPORT
